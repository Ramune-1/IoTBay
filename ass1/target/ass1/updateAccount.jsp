...
<body>
    <div class="header">
        ...
        <div class="topic">Update</div></div>
    ...
    <div class="body"> <div class="container">
        ...
        <div>
            ...
            <input type="text" name="username" value="<%=customer.getUserName()%>"><br>
        </div>
        <div> 
        ...
        <div>
            ...
            <input type="gmail" name="gmail" value="<%=customer.getGmail()%>"><br>
        </div>
        <div>
            <label for="password">Password</label><br>
            <input type="password" name="password" value="<%=customer.getPassWord()%>"><br>
        </div>
        <div>
         ...
         <div>
            ...
            <input type="radio" id="male" name="gender" value="male" <%= customer.getGender().equals("male") ? "checked" : ""%>>
         </div>
         <div>
            <label for="female">Female</label>
            <input type="radio" id="female" name="gender" value="female" <%= customer.getGender().equals("female") ? "checked" : ""%>>
         </div>
        </div>
        <div class="choice">
            <div class="cancel"><a href="accountView.jsp">Return</a></div>
